...
public class MidPointLines  implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        DrawMPL(gl,-90,0,60,-30); 	//left to bottom_right
        DrawMPL(gl,90,0,-60,-30); 	//right to bottom_left
        
        DrawMPL(gl,0,20,-60,-30); 	//top to bottom_left
        DrawMPL(gl,0,20,60,-30); 	//top to bottom_right
        
      //  DrawMPL(gl,-2,10,2,-10); 
  ...
  /*  private int func(int x, float y){
    ...
    public void DrawMPL(GL2 gl, int x1, int y1, int x2, int y2){
        ...
        //plotting the initial coordinates of  original zone
    ...
    void drawPixelOriginal(GL2 gl,int x,int y,int zone){
        ...
        x = convertXp(x,y,zone);
        y = convertYp(x,y,zone);
    ...
    int convertXp(int x, int y, int zone){
        int convertedX=0;
        switch(zone){
        case 0:
        	return x;
  ...
  //conversion to corresponding zone-0 y_value
    int convertYp(int x, int y, int zone){
       int convertedY=0; 
       switch(zone){
    	case 0:
    		return y;
